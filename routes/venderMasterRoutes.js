...
const salesContractController = require("../controllers/vendermasterController");
...
router
  .route("/create-sales-contract")
  .post(salesContractController.createSauda);

router.route("/additional-data").get(salesContractController.getAdditionalData);
router
  .route("/get-pending-saudas/")
  .get(salesContractController.getAllContract);
